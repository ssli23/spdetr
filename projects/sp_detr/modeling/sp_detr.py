...
class SPDETR(nn.Module):
    ...
    def init_weights(self):
        """Initialize weights for SP-DETR."""
    ...
    def forward(self, batched_inputs):
        ...
        features = self.backbone(images.tensor)[self.in_features[0]] #s3= self.in_features[0]
        features_s4 = self.backbone(images.tensor)[self.in_features[1]] #s4
        features_s5 = self.backbone(images.tensor)[self.in_features[2]] #s5
        ...
        hidden_states, reference_boxes = self.transformer(
            features, img_masks, dynamic_anchor_boxes, pos_embed, features_s4, features_s5
        )
    ...
    def inference(self, box_cls, box_pred, image_sizes):
        """Inference function for SP-DETR
